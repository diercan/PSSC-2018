...
INSERT INTO `hph`.`flight` (`id`,`from_city`, `sent_emails`, `time`, `to_city`, `airplane_id`, `seats_taken`, `all_emails_sent`) VALUES (1, 'Timisoara', '0', '2019-01-06 19:27:10', 'Bucuresti', '1', 0, true);
INSERT INTO `hph`.`flight` (`id`,`from_city`, `sent_emails`, `time`, `to_city`, `airplane_id`, `seats_taken`, `all_emails_sent`) VALUES (2, 'Bucuresti', '0', '2019-01-06 19:27:10', 'Timisoara', '1', 0, true);
